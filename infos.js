const greeting = {
  ...
  profile:
    'https://avatars.githubusercontent.com/u/37934938?u=63f2e7c27905f77aed4ec78e6742381a196070ef&v=4',
};
...
const blogSection = {
  ...
  blogs: [
    {
      url: 'https://blog.khalidabdellah.com/',
  ...
  projects: [
    {
      ...
      picture:
        'https://i0.wp.com/9to5google.com/wp-content/uploads/sites/4/2022/04/switch_to_android_app_1.jpg?w=2500&quality=82&strip=all&ssl=1',
    ...
    },
    {
      ...
      picture:
        'https://i2.wp.com/mozartec.com/wp-content/uploads/2019/04/flutter.jpeg?fit=1500%2C750&ssl=1',
...
export { greeting, socialMediaLinks, skillsSection, blogSection, contactInfo, Projects };
